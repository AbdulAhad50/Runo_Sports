...
const HeroBar = () => {
  ...
  <div className="w-[100%] bg-black flex justify-center pb-20">

 
    <div className={`relative flex gap-[2vw] w-[80%] h-[400px] bg-black ${HeroBar}`}>
        ...
        <div className="text-[#ffffff] flex flex-col gap-[2vw] text-left z-10">
